...
TagMonster is a desktop program designed to automate some of the tedious and error-prone parts of archiving work. This project is developed as an internal tool for [GenEq UC Berkeley](https://cejce.berkeley.edu/geneq). It is in active development and unsuitable for production use outside of the GenEq organization.
