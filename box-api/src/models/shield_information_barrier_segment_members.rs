...
/// ShieldInformationBarrierSegmentMembers : List of Shield Information Barrier Member objects.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ShieldInformationBarrierSegmentMembers {
    ...
    pub entries: Option<Vec<models::ShieldInformationBarrierSegmentMember>>,
}

impl ShieldInformationBarrierSegmentMembers {
    /// List of Shield Information Barrier Member objects.
    pub fn new() -> ShieldInformationBarrierSegmentMembers {
