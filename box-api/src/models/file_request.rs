...
pub struct FileRequest {
    ...
    #[serde(rename = "folder")]
    pub folder: Box<models::FolderMini>,
    ...
    pub updated_by: Option<Box<models::UserMini>>,
...
impl FileRequest {
    ...
    pub fn new(id: String, r#type: Type, folder: models::FolderMini, created_at: String, updated_at: String) -> FileRequest {
        FileRequest {
            id,
            r#type,
            title: None,
