...
pub struct TrashWebLinkRestored {
    ...
    pub parent: Option<Box<models::FolderMini>>,
    ...
    pub path_collection: Box<models::TrashWebLinkRestoredPathCollection>,
...
impl TrashWebLinkRestored {
    ...
    pub fn new(sequence_id: Option<String>, path_collection: models::TrashWebLinkRestoredPathCollection) -> TrashWebLinkRestored {
