...
pub struct PostRetentionPolicyAssignmentsRequest {
    ...
    pub assign_to: Box<models::PostRetentionPolicyAssignmentsRequestAssignTo>,
    ...
    pub filter_fields: Option<Vec<models::PostRetentionPolicyAssignmentsRequestFilterFieldsInner>>,
...
impl PostRetentionPolicyAssignmentsRequest {
    pub fn new(policy_id: String, assign_to: models::PostRetentionPolicyAssignmentsRequestAssignTo) -> PostRetentionPolicyAssignmentsRequest {
