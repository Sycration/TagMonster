...
/// ShieldInformationBarrierSegments : List of Shield Information Barrier Segment objects.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ShieldInformationBarrierSegments {
    ...
    pub entries: Option<Vec<models::ShieldInformationBarrierSegment>>,
}

impl ShieldInformationBarrierSegments {
    /// List of Shield Information Barrier Segment objects.
    pub fn new() -> ShieldInformationBarrierSegments {
