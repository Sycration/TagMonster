...
/// AiLlmEndpointParamsAws : AI LLM endpoint params AWS object.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AiLlmEndpointParamsAws {
...
impl AiLlmEndpointParamsAws {
    /// AI LLM endpoint params AWS object.
    pub fn new(r#type: Type) -> AiLlmEndpointParamsAws {
