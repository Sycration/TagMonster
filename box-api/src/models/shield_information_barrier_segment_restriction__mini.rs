...
impl ShieldInformationBarrierSegmentRestrictionMini {
    ...
    pub fn new(shield_information_barrier_segment: models::ShieldInformationBarrierSegmentRestrictionMiniAllOfShieldInformationBarrierSegment, restricted_segment: models::ShieldInformationBarrierSegmentRestrictionMiniAllOfRestrictedSegment) -> ShieldInformationBarrierSegmentRestrictionMini {
