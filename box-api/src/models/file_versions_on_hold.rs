...
/// FileVersionsOnHold : A list of files on hold for legal policy assignment.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct FileVersionsOnHold {
    ...
    pub entries: Option<Vec<models::FileVersion>>,
}

impl FileVersionsOnHold {
    /// A list of files on hold for legal policy assignment.
    pub fn new() -> FileVersionsOnHold {
        FileVersionsOnHold {
            limit: None,
            next_marker: None,
            prev_marker: None,
