...
/// ItemsOffsetPaginated : A list of files, folders, and web links in their mini representation.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ItemsOffsetPaginated {
