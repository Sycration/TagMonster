...
/// SignRequestSigner : The schema for a Signer object used on the body of a Box Sign request object.
...
pub struct SignRequestSigner {
    ...
    #[serde(rename = "signer_decision", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub signer_decision: Option<Option<Box<models::SignRequestSignerAllOfSignerDecision>>>,
    #[serde(rename = "inputs", skip_serializing_if = "Option::is_none")]
    pub inputs: Option<Vec<models::SignRequestSignerInput>>,
    /// URL to direct a signer to for signing.
    #[serde(rename = "embed_url", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub embed_url: Option<Option<String>>,
    /// This URL is specifically designed for signing documents within an HTML `iframe` tag. It will be returned in the response only if the `embed_url_external_user_id` parameter was passed in the `create Box Sign request` call.
    #[serde(rename = "iframeable_embed_url", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub iframeable_embed_url: Option<Option<String>>,
}

impl SignRequestSigner {
    /// The schema for a Signer object used on the body of a Box Sign request object.
    pub fn new(email: Option<String>) -> SignRequestSigner {
        SignRequestSigner {
            email,
            role: None,
            is_in_person: None,
