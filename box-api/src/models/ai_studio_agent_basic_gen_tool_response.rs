...
/// AiStudioAgentBasicGenToolResponse : AI agent basic tool used to generate text.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AiStudioAgentBasicGenToolResponse {
    ...
    #[serde(rename = "content_template", skip_serializing_if = "Option::is_none")]
    pub content_template: Option<String>,
    /// True if system message contains custom instructions placeholder, false otherwise.
    #[serde(rename = "is_custom_instructions_included", skip_serializing_if = "Option::is_none")]
...
impl AiStudioAgentBasicGenToolResponse {
    /// AI agent basic tool used to generate text.
    pub fn new() -> AiStudioAgentBasicGenToolResponse {
        AiStudioAgentBasicGenToolResponse {
            ...
            is_custom_instructions_included: None,
            warnings: None,
        }
    }
}
