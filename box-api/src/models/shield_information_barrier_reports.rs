...
/// ShieldInformationBarrierReports : A list of shield barrier reports.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ShieldInformationBarrierReports {
    ...
    pub entries: Option<Vec<models::ShieldInformationBarrierReport>>,
}

impl ShieldInformationBarrierReports {
    /// A list of shield barrier reports.
    pub fn new() -> ShieldInformationBarrierReports {
