...
/// AiStudioAgentBasicGenTool : AI agent basic tool used to generate text.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AiStudioAgentBasicGenTool {
...
impl AiStudioAgentBasicGenTool {
    /// AI agent basic tool used to generate text.
    pub fn new() -> AiStudioAgentBasicGenTool {
