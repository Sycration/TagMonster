...
/// CollaborationsOffsetPaginated : A list of collaborations.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CollaborationsOffsetPaginated {
...
impl CollaborationsOffsetPaginated {
    /// A list of collaborations.
    pub fn new() -> CollaborationsOffsetPaginated {
