...
/// PutFilesIdRequestSharedLink : Defines a shared link for a file. Set this to `null` to remove the shared link.
...
pub struct PutFilesIdRequestSharedLink {
    ...
    pub permissions: Option<Box<models::PutFilesIdRequestSharedLinkAllOfPermissions>>,
}
