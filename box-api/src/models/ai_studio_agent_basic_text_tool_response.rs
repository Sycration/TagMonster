...
/// AiStudioAgentBasicTextToolResponse : AI agent processor used to handle basic text.
...
impl AiStudioAgentBasicTextToolResponse {
    /// AI agent processor used to handle basic text.
    pub fn new() -> AiStudioAgentBasicTextToolResponse {
