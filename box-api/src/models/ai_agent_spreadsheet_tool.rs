...
/// AiAgentSpreadsheetTool : The AI agent tool used to handle spreadsheets and tabular data.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AiAgentSpreadsheetTool {
