...
/// AiAgentLongTextTool : AI agent processor used to to handle longer text.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AiAgentLongTextTool {
...
impl AiAgentLongTextTool {
    /// AI agent processor used to to handle longer text.
    pub fn new() -> AiAgentLongTextTool {
        AiAgentLongTextTool {
            model: None,
