...
/// FileAllOfSharedLink : The shared link for this file. This value will be `null` if no shared link has been created for this file.
...
pub struct FileAllOfSharedLink {
    ...
    pub permissions: Option<Box<models::SharedLinkPermissions>>,
