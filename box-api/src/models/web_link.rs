...
pub struct WebLink {
    ...
    pub path_collection: Option<Box<models::TrashWebLinkRestoredPathCollection>>,
    ...
    pub shared_link: Option<Option<Box<models::WebLinkAllOfSharedLink>>>,
...
impl WebLink {
    ...
    pub fn new(id: String, r#type: Type) -> WebLink {
        WebLink {
            id,
            r#type,
            etag: None,
