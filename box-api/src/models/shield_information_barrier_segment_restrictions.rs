...
/// ShieldInformationBarrierSegmentRestrictions : List of shield information barrier segment restriction objects.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ShieldInformationBarrierSegmentRestrictions {
    ...
    pub entries: Option<Vec<models::ShieldInformationBarrierSegmentRestriction>>,
}

impl ShieldInformationBarrierSegmentRestrictions {
    /// List of shield information barrier segment restriction objects.
    pub fn new() -> ShieldInformationBarrierSegmentRestrictions {
