...
pub struct PutFoldersIdRequest {
    ...
    pub parent: Option<Box<models::PutFoldersIdRequestParent>>,
    #[serde(rename = "shared_link", skip_serializing_if = "Option::is_none")]
    pub shared_link: Option<Box<models::PutFoldersIdRequestSharedLink>>,
    #[serde(rename = "folder_upload_email", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub folder_upload_email: Option<Option<Box<models::PutFoldersIdRequestFolderUploadEmail>>>,
