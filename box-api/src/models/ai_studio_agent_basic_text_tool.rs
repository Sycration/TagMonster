...
/// AiStudioAgentBasicTextTool : AI agent processor used to handle basic text.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AiStudioAgentBasicTextTool {
...
impl AiStudioAgentBasicTextTool {
    /// AI agent processor used to handle basic text.
    pub fn new() -> AiStudioAgentBasicTextTool {
