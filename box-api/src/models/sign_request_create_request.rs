...
/// SignRequestCreateRequest : Creates a Box Sign request object.
...
pub struct SignRequestCreateRequest {
    ...
    pub signers: Vec<models::SignRequestCreateSigner>,
...
impl SignRequestCreateRequest {
    ...
    pub fn new(signers: Vec<models::SignRequestCreateSigner>) -> SignRequestCreateRequest {
...
impl Default for SignatureColor {
    fn default() -> SignatureColor {
        Self::Blue
    }
}
