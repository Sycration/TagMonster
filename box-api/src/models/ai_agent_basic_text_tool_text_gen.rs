...
/// AiAgentBasicTextToolTextGen : AI agent processor used to handle basic text.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AiAgentBasicTextToolTextGen {
...
impl AiAgentBasicTextToolTextGen {
    /// AI agent processor used to handle basic text.
    pub fn new() -> AiAgentBasicTextToolTextGen {
