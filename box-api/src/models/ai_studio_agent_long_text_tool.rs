...
/// AiStudioAgentLongTextTool : AI agent processor used to to handle longer text.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct AiStudioAgentLongTextTool {
...
impl AiStudioAgentLongTextTool {
    /// AI agent processor used to to handle longer text.
    pub fn new() -> AiStudioAgentLongTextTool {
