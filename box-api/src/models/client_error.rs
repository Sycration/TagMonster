...
pub struct ClientError {
    ...
    #[serde(rename = "context_info", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub context_info: Option<Option<std::collections::HashMap<String, serde_json::Value>>>,
