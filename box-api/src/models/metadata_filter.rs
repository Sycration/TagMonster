...
/// MetadataFilter : A metadata template used to filter the search results.
...
pub struct MetadataFilter {
    ...
    pub filters: Option<std::collections::HashMap<String, models::MetadataFilterValue>>,
}
