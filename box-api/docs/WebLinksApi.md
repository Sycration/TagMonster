...
> models::WebLink get_web_links_id(web_link_id, boxapi)
Get web link
...
> models::WebLink post_web_links(post_web_links_request)
Create web link
...
> models::WebLink put_web_links_id(web_link_id, put_web_links_id_request)
Update web link
