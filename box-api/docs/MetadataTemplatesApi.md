...
> models::MetadataTemplates get_metadata_templates(metadata_instance_id, marker, limit)
...
[**models::MetadataTemplates**](MetadataTemplates.md)
...
> models::MetadataTemplates get_metadata_templates_enterprise(marker, limit)
...
> models::MetadataTemplates get_metadata_templates_global(marker, limit)
...
> models::MetadataTemplate get_metadata_templates_id(template_id)
...
[**models::MetadataTemplate**](MetadataTemplate.md)
...
> models::MetadataTemplate get_metadata_templates_id_id_schema(scope, template_key)
...
> models::MetadataTemplate post_metadata_templates_schema(post_metadata_templates_schema_request)
...
> models::MetadataTemplate put_metadata_templates_id_id_schema(scope, template_key, a_metadata_template_update_operation)
...
**scope** | **String** | The scope of the metadata template. | [required] |
**template_key** | **String** | The name of the metadata template. | [required] |
**a_metadata_template_update_operation** | Option<[**Vec<models::AMetadataTemplateUpdateOperation>**](A_metadata_template_update_operation.md)> |  |  |
