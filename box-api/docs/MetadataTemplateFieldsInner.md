...
**options** | Option<[**Vec<models::MetadataTemplateFieldsInnerAllOfOptionsInner>**](MetadataTemplate_fields_inner_allOf_options_inner.md)> | A list of options for this field. This is used in combination with the `enum` and `multiSelect` field types. | [optional]
