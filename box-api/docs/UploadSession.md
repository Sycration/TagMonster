...
**r#type** | Option<**String**> | The value will always be `upload_session`. | [optional]
...
**session_endpoints** | Option<[**models::UploadSessionSessionEndpoints**](UploadSession_session_endpoints.md)> |  | [optional]
