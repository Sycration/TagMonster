...
------------ | ------------- | ------------- | -------------
**user** | [**models::PostGroupMembershipsRequestUser**](post_group_memberships_request_user.md) |  | 
**group** | [**models::PostGroupMembershipsRequestGroup**](post_group_memberships_request_group.md) |  | 
