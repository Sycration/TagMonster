...
**appears** | Option<[**Vec<models::TimelineSkillCardEntriesInnerAppearsInner>**](TimelineSkillCard_entries_inner_appears_inner.md)> | Defines a list of timestamps for when this item should appear on the timeline. | [optional]
