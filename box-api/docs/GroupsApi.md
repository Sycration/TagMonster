...
> models::Groups get_groups(filter_term, fields, limit, offset)
...
> models::GroupFull get_groups_id(group_id, fields)
Get group
...
[**models::GroupFull**](Group--Full.md)
...
> models::GroupFull post_groups(fields, post_groups_request)
Create group
...
> models::GroupFull put_groups_id(group_id, fields, put_groups_id_request)
Update group
