...
**r#type** | Option<**String**> | The value will always be `task_assignment`. | [optional]
**item** | Option<[**models::FileMini**](File--Mini.md)> | The file that the task has been assigned to. | [optional]
**assigned_to** | Option<[**models::UserMini**](User--Mini.md)> | The user that the task has been assigned to. | [optional]
...
**assigned_by** | Option<[**models::UserMini**](User--Mini.md)> | The user who assigned this task. | [optional]
