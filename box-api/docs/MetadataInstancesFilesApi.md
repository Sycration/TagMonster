...
> models::Metadatas get_files_id_metadata(file_id)
...
> models::MetadataFull get_files_id_metadata_id_id(file_id, scope, template_key)
...
> models::MetadataFull post_files_id_metadata_id_id(file_id, scope, template_key, request_body)
...
> models::MetadataFull put_files_id_metadata_id_id(file_id, scope, template_key, a_metadata_instance_update_operation)
