...
> models::Tasks get_files_id_tasks(file_id)
List tasks on file
...
> models::Task get_tasks_id(task_id)
Get task
...
> models::Task post_tasks(post_tasks_request)
Create task
...
> models::Task put_tasks_id(task_id, put_tasks_id_request)
Update task
