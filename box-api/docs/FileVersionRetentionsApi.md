...
> models::FileVersionRetentions get_file_version_retentions(file_id, file_version_id, policy_id, disposition_action, disposition_before, disposition_after, limit, marker)
...
[**models::FileVersionRetentions**](FileVersionRetentions.md)
...
> models::FileVersionRetention get_file_version_retentions_id(file_version_retention_id)
...
[**models::FileVersionRetention**](FileVersionRetention.md)
