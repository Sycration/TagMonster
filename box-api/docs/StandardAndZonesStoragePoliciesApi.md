...
------------- | ------------- | -------------
[**get_storage_policies**](StandardAndZonesStoragePoliciesApi.md#get_storage_policies) | **GET** /storage_policies | List storage policies
[**get_storage_policies_id**](StandardAndZonesStoragePoliciesApi.md#get_storage_policies_id) | **GET** /storage_policies/{storage_policy_id} | Get storage policy



## get_storage_policies

> models::StoragePolicies get_storage_policies(fields, marker, limit)
...
[**models::StoragePolicies**](StoragePolicies.md)
...
> models::StoragePolicy get_storage_policies_id(storage_policy_id)
Get storage policy
...
[**models::StoragePolicy**](StoragePolicy.md)
