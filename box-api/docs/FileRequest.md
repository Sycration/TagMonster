...
**r#type** | **String** | The value will always be `file_request`. | [readonly]
...
**folder** | [**models::FolderMini**](Folder--Mini.md) | The folder that this file request is associated with.  Files submitted through the file request form will be uploaded to this folder. | 
...
**created_by** | Option<[**models::UserMini**](User--Mini.md)> | The user who created this file request. | [optional]
**created_at** | **String** | The date and time when the file request was created. | 
**updated_by** | Option<[**models::UserMini**](User--Mini.md)> | The user who last modified this file request. | [optional]
