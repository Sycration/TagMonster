...
> models::DevicePinner get_device_pinners_id(device_pinner_id)
Get device pin
...
[**models::DevicePinner**](DevicePinner.md)
...
> models::DevicePinners get_enterprises_id_device_pinners(enterprise_id, marker, limit, direction)
...
[**models::DevicePinners**](DevicePinners.md)
