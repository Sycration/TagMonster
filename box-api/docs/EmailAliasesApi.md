...
> models::EmailAliases get_users_id_email_aliases(user_id)
...
[**models::EmailAliases**](EmailAliases.md)
...
> models::EmailAlias post_users_id_email_aliases(user_id, post_users_id_email_aliases_request)
Create email alias
...
[**models::EmailAlias**](EmailAlias.md)
