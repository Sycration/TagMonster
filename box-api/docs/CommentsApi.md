...
> models::CommentFull get_comments_id(comment_id, fields)
Get comment
...
[**models::CommentFull**](Comment--Full.md)
...
> models::Comments get_files_id_comments(file_id, fields, limit, offset)
List file comments
...
> models::CommentFull post_comments(fields, post_comments_request)
Create comment
...
> models::CommentFull put_comments_id(comment_id, fields, put_comments_id_request)
Update comment
