...
> models::TaskAssignment get_task_assignments_id(task_assignment_id)
Get task assignment
...
[**models::TaskAssignment**](TaskAssignment.md)
...
> models::TaskAssignments get_tasks_id_assignments(task_id)
...
[**models::TaskAssignments**](TaskAssignments.md)
...
> models::TaskAssignment post_task_assignments(post_task_assignments_request)
Assign task
...
> models::TaskAssignment put_task_assignments_id(task_assignment_id, put_task_assignments_id_request)
