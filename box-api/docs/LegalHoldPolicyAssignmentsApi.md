...
[**get_legal_hold_policy_assignments_id_files_on_hold**](LegalHoldPolicyAssignmentsApi.md#get_legal_hold_policy_assignments_id_files_on_hold) | **GET** /legal_hold_policy_assignments/{legal_hold_policy_assignment_id}/files_on_hold | List files with current file versions for legal hold policy assignment
...
> models::LegalHoldPolicyAssignments get_legal_hold_policy_assignments(policy_id, assign_to_type, assign_to_id, marker, limit, fields)
...
[**models::LegalHoldPolicyAssignments**](LegalHoldPolicyAssignments.md)
...
> models::LegalHoldPolicyAssignment get_legal_hold_policy_assignments_id(legal_hold_policy_assignment_id)
...
[**models::LegalHoldPolicyAssignment**](LegalHoldPolicyAssignment.md)
...
> models::FileVersionsOnHold get_legal_hold_policy_assignments_id_file_versions_on_hold(legal_hold_policy_assignment_id, marker, limit, fields)
...
[**models::FileVersionsOnHold**](FileVersionsOnHold.md)
...
> models::FilesOnHold get_legal_hold_policy_assignments_id_files_on_hold(legal_hold_policy_assignment_id, marker, limit, fields)
...
[**models::FilesOnHold**](FilesOnHold.md)
...
> models::LegalHoldPolicyAssignment post_legal_hold_policy_assignments(post_legal_hold_policy_assignments_request)
