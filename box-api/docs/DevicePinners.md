...
------------ | ------------- | ------------- | -------------
**entries** | Option<[**Vec<models::DevicePinner>**](DevicePinner.md)> | A list of device pins. | [optional]
...
**order** | Option<[**Vec<models::DevicePinnersOrderInner>**](DevicePinners_order_inner.md)> | The order by which items are returned. | [optional]
