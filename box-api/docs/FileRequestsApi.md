...
> models::FileRequest get_file_requests_id(file_request_id)
Get file request
...
[**models::FileRequest**](FileRequest.md)
...
> models::FileRequest post_file_requests_id_copy(file_request_id, file_request_copy_request)
Copy file request
...
> models::FileRequest put_file_requests_id(file_request_id, if_match, file_request_update_request)
Update file request
