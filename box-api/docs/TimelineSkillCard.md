...
**skill_card_type** | **String** | The value will always be `timeline`. | 
**skill_card_title** | Option<[**models::TimelineSkillCardSkillCardTitle**](TimelineSkillCard_skill_card_title.md)> |  | [optional]
...
**entries** | [**Vec<models::TimelineSkillCardEntriesInner>**](TimelineSkillCard_entries_inner.md) | A list of entries on the timeline. | 
