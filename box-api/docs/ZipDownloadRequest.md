...
------------ | ------------- | ------------- | -------------
**items** | [**Vec<models::ZipDownloadRequestItemsInner>**](ZipDownloadRequest_items_inner.md) | A list of items to add to the `zip` archive. These can be folders or files. | 
