...
**r#type** | **String** | Specifies the response as search result items without shared links. | 
**entries** | Option<[**Vec<models::SearchResultItem>**](SearchResultItem.md)> | The search results for the query provided. | [optional]
