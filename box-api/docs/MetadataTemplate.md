...
**fields** | Option<[**Vec<models::MetadataTemplateFieldsInner>**](MetadataTemplate_fields_inner.md)> | An ordered list of template fields which are part of the template. Each field can be a regular text field, date field, number field, as well as a single or multi-select list. | [optional]
