...
**r#type** | **String** | The value will always be `retention_policy`. | 
...
**created_by** | Option<[**models::UserMini**](User--Mini.md)> | A mini user object representing the user that created the retention policy. | [optional]
...
**assignment_counts** | Option<[**models::RetentionPolicyAllOfAssignmentCounts**](RetentionPolicy_allOf_assignment_counts.md)> |  | [optional]
