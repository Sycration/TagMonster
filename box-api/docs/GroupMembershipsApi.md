...
> models::GroupMembership get_group_memberships_id(group_membership_id, fields)
...
> models::GroupMemberships get_groups_id_memberships(group_id, limit, offset)
...
[**models::GroupMemberships**](GroupMemberships.md)
...
> models::GroupMemberships get_users_id_memberships(user_id, limit, offset)
List user's groups
...
> models::GroupMembership post_group_memberships(fields, post_group_memberships_request)
Add user to group
...
> models::GroupMembership put_group_memberships_id(group_membership_id, fields, put_group_memberships_id_request)
