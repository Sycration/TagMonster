...
**notification_email** | Option<[**models::UserAllOfNotificationEmail**](User_allOf_notification_email.md)> |  | [optional]
**role** | Option<**String**> | The user’s enterprise role. | [optional]
**tracking_codes** | Option<[**Vec<models::TrackingCode>**](TrackingCode.md)> | Tracking codes allow an admin to generate reports from the admin console and assign an attribute to a specific group of users. This setting must be enabled for an enterprise before it can be used. | [optional]
...
**enterprise** | Option<[**models::UserFullAllOfEnterprise**](User__Full_allOf_enterprise.md)> |  | [optional]
