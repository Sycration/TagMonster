...
**options** | Option<[**Vec<models::MetadataOptionWrite>**](Metadata_Option__Write_.md)> | A list of options for this field. This is used in combination with the `enum` and `multiSelect` field types. | [optional]
