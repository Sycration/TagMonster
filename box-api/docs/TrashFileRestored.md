...
**path_collection** | [**models::FileAllOfPathCollection**](File_allOf_path_collection.md) |  | 
...
**modified_by** | [**models::UserMini**](User--Mini.md) | The user who last modified this file. | 
**owned_by** | [**models::UserMini**](User--Mini.md) | The user who owns this file. | 
...
**parent** | Option<[**models::FolderMini**](Folder--Mini.md)> | The folder that this file is located within. | [optional]
