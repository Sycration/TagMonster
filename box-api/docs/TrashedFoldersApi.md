...
> models::TrashFolder get_folders_id_trash(folder_id, fields)
Get trashed folder
...
[**models::TrashFolder**](TrashFolder.md)
...
> models::TrashFolderRestored post_folders_id(folder_id, fields, post_folders_id_request)
Restore folder
...
[**models::TrashFolderRestored**](TrashFolderRestored.md)
