...
> models::FileFull get_files_id(file_id, fields, if_none_match, boxapi, x_rep_hints)
...
- **Content-Type**: Not defined
- **Accept**: image/jpg, image/png, application/json
...
> models::UploadUrl options_files_content(options_files_content_request)
...
> models::FileFull post_files_id_copy(file_id, fields, post_files_id_copy_request)
Copy file
...
> models::FileFull put_files_id(file_id, fields, if_match, put_files_id_request)
Update file
