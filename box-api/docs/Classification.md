...
**dollar_template** | Option<**String**> | The value will always be `securityClassification-6VMVochwUWo`. | [optional]
...
**dollar_type_version** | Option<**f64**> | The version of the metadata template. This version starts at 0 and increases every time the template is updated. This is mostly for internal use. | [optional]
