...
**entries** | Option<[**Vec<models::ShieldInformationBarrierSegmentRestriction>**](ShieldInformationBarrierSegmentRestriction.md)> | A list of shield information barrier segment restriction objects. | [optional]
