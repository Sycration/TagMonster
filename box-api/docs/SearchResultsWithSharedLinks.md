...
**r#type** | **String** | Specifies the response as search result items with shared links. | 
**entries** | Option<[**Vec<models::SearchResultWithSharedLink>**](SearchResultWithSharedLink.md)> | The search results for the query provided, including the additional information about any shared links through which the item has been shared with the user. | [optional]
