...
> models::Metadatas get_folders_id_metadata(folder_id)
...
> models::MetadataFull get_folders_id_metadata_id_id(folder_id, scope, template_key)
...
[**models::MetadataFull**](Metadata--Full.md)
...
> models::MetadataFull post_folders_id_metadata_id_id(folder_id, scope, template_key, request_body)
...
> models::MetadataFull put_folders_id_metadata_id_id(folder_id, scope, template_key, a_metadata_instance_update_operation)
...
**scope** | **String** | The scope of the metadata template. | [required] |
**template_key** | **String** | The name of the metadata template. | [required] |
**a_metadata_instance_update_operation** | Option<[**Vec<models::AMetadataInstanceUpdateOperation>**](A_metadata_instance_update_operation.md)> |  |  |
