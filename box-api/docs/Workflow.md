...
**r#type** | Option<**String**> | The value will always be `workflow`. | [optional]
...
**flows** | Option<[**Vec<models::WorkflowAllOfFlows>**](Workflow_allOf_flows.md)> | A list of flows assigned to a workflow. | [optional]
