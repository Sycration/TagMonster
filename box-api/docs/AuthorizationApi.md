...
**scope** | Option<**String**> | A space-separated list of application scopes you'd like to authenticate the user for. This defaults to all the scopes configured for the application in its configuration page. |  |
...
> models::AccessToken post_oauth2_token(grant_type, client_id, client_secret, code, refresh_token, assertion, subject_token, subject_token_type, actor_token, actor_token_type, scope, resource, box_subject_type, box_subject_id, box_shared_link)
...
> models::AccessToken post_oauth2_token_refresh(grant_type, client_id, client_secret, refresh_token)
