...
> models::FolderLocks get_folder_locks(folder_id)
List folder locks
...
[**models::FolderLocks**](FolderLocks.md)
...
> models::FolderLock post_folder_locks(post_folder_locks_request)
Create folder lock
...
[**models::FolderLock**](FolderLock.md)
