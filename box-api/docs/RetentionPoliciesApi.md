...
> models::RetentionPolicies get_retention_policies(policy_name, policy_type, created_by_user_id, fields, limit, marker)
...
> models::RetentionPolicy get_retention_policies_id(retention_policy_id, fields)
...
[**models::RetentionPolicy**](RetentionPolicy.md)
...
> models::RetentionPolicy post_retention_policies(post_retention_policies_request)
...
> models::RetentionPolicy put_retention_policies_id(retention_policy_id, put_retention_policies_id_request)
