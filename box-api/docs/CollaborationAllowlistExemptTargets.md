...
**entries** | Option<[**Vec<models::CollaborationAllowlistExemptTarget>**](CollaborationAllowlistExemptTarget.md)> | A list of users exempt from any of the restrictions imposed by the list of allowed collaboration domains for this enterprise. | [optional]
