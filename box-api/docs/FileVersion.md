...
**r#type** | **String** | The value will always be `file_version`. | 
...
**modified_by** | Option<[**models::UserMini**](User--Mini.md)> | The user who last updated the file version. | [optional]
**trashed_at** | Option<**String**> | When the file version object was trashed. | [optional]
**trashed_by** | Option<[**models::UserMini**](User--Mini.md)> | The user who trashed the file version. | [optional]
**restored_at** | Option<**String**> | When the file version was restored from the trash. | [optional]
**restored_by** | Option<[**models::UserMini**](User--Mini.md)> | The user who restored the file version from the trash. | [optional]
