...
> models::FolderFull get_folders_id(folder_id, fields, if_none_match, boxapi, sort, direction, offset, limit)
...
> models::Items get_folders_id_items(folder_id, fields, usemarker, marker, offset, limit, boxapi, sort, direction)
...
> models::FolderFull post_folders(fields, post_folders_request)
Create folder
...
> models::FolderFull post_folders_id_copy(folder_id, fields, post_folders_id_copy_request)
Copy folder
...
> models::FolderFull put_folders_id(folder_id, fields, if_match, put_folders_id_request)
Update folder
