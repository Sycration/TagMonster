...
> models::ZipDownloadStatus get_zip_downloads_id_status(zip_download_id)
...
[**models::ZipDownloadStatus**](ZipDownloadStatus.md)
...
> models::ZipDownload post_zip_downloads(zip_download_request)
Create zip download
...
[**models::ZipDownload**](ZipDownload.md)
