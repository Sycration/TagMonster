...
**r#type** | Option<**String**> | The value will always be `comment`. | [optional]
...
**created_by** | Option<[**models::UserMini**](User--Mini.md)> | A mini user object representing the author of the comment. | [optional]
...
**item** | Option<[**models::CommentAllOfItem**](Comment_allOf_item.md)> |  | [optional]
