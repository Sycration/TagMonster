...
> models::Events get_events(stream_type, stream_position, limit, event_type, created_after, created_before)
...
> models::RealtimeServers options_events()
...
[**models::RealtimeServers**](RealtimeServers.md)
